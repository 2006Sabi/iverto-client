...
export const AnomalyDetailView = ({
  ...
  const getCameraId = () => {
    ...
    if (anomaly.camera_id && typeof anomaly.camera_id === "object" && anomaly.camera_id._id) return anomaly.camera_id._id;
    if (anomaly.camera_id && typeof anomaly.camera_id === "object" && anomaly.camera_id.id) return anomaly.camera_id.id;
    return "";
  };

  const { data: cameraData, isLoading: isCameraLoading } = useGetCameraQuery(getCameraId());
