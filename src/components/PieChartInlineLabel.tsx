...
const PieChartInlineLabel: React.FC<PieChartInlineLabelProps> = ({ data }) => {
  ...
  // Fetch recent anomalies from API
  const { data: anomalies, isLoading } = useGetRecentAnomaliesQuery({ limit: 100 });

  // Transform anomalies into chart data
  const apiChartData = React.useMemo(() => {
