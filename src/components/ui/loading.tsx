    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-semibold text-foreground">Vigilant Vision</h2>
  ...
  return (
    <div className="space-y-4">
      {Array.from({ length: count }).map((_, i) => (
        <div 
          key={i} 
          className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-muted/20 to-muted/10"
        >
